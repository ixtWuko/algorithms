...
table_finished = [[3,2,9,4,1,8,6,7,5],[5,7,1,6,9,3,2,4,8],[4,8,6,5,7,2,3,1,9],[7,9,5,1,2,6,8,3,4],[1,6,8,7,3,4,5,9,2],[2,3,4,9,8,5,1,6,7],[6,4,3,8,5,7,9,2,1],[8,1,7,2,6,9,4,5,3],[9,5,2,3,4,1,7,8,6]]
...
def step_two(table, pow = 9):
    ...
    for n in possible_numbers_table[x][y]:
        ...
        temp_table[x][y] = n
#        temp_had_tried = deepcopy(cell_had_tyied)
